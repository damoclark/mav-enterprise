...
{if $browser.browser == "Firefox"}
	...
	{if $browser.majorver >= 15}
    	...
    	<ol class="spaced">
			...
			<li>Now all you need do is navigate to your <a href="{$moodle}">Moodle</a> course site, and click the <i>Turn Activity View On</i> link (see below) in the Course Administration Block.</li>
